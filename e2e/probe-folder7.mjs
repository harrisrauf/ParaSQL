// Probe: drive the open folder dialog with exp-folder5.ps1.
...
await sleep(2500);
const r = spawnSync('powershell.exe', ['-NoProfile', '-ExecutionPolicy', 'Bypass', '-File', 'e2e/exp-folder5.ps1', '-FilePath', SALES_DIR], { encoding: 'utf8', cwd: process.cwd(), timeout: 45000 });
